                        ...
                        {activeTab === 'Dashboard' && (
                            ...
                            >
                                <AdminDashboard
                                    reports={reports}
                                    patients={patients}
                                    totalPatientsCount={statsCounts.totalPatients}
                                    totalReportsCount={statsCounts.totalReports}
                                    pendingReportsCount={statsCounts.pendingReports}
                                    criticalReportsCount={statsCounts.criticalReports}
                        ...
                        {activeTab === 'Patients' && (
                            ...
                            >
                                <PatientsPanel
                                    ...
                                    searchTerm={patientsSearch}
                                    onSearchChange={(value) => {
                                        setPatientsSearch(value);
                                        setPatientsPage(1);
                                    }}
                                    currentPage={patientsPage}
                                    onPageChange={setPatientsPage}
                                    totalPatientsCount={patientsTotal}
                                    pageSize={10}
                                />
                            </motion.div>
                        )}
                                        ...
                                        {reportsTotal > 10 && (
                                            <div className="flex items-center justify-between border-t border-slate-100 pt-4 mt-6">
                                                ...
                                                <span className="text-xs font-bold text-slate-500">
                                                    Page {reportsPage} of {Math.ceil(reportsTotal / 10)}
                                                </span>
                                                <button
                                                    onClick={() => setReportsPage(prev => Math.min(prev + 1, Math.ceil(reportsTotal / 10)))}
